...
<style>
/* Override homelay Bootstrap wrapper interference */
#homeid { padding: 0 !important; margin: 0 !important; width: 100% !important; max-width: 100% !important; }
...
.qx-badge-container { margin-bottom: 16px; }
...
.qx-big-card-desc { font-size: 10pt; color: #475569; line-height: 1.6; }
...
.qx-project-title { font-size: 13pt; font-weight: 600; color: #0f172a; margin: 0 0 8px 0; }
  ...
  <div class="qx-project-row">
    <div class="qx-project-col">
      <div class="qx-project-card">
        <div class="qx-project-title">Open-Source LLM Activation Monitor</div>
    ...
    <div class="qx-project-col">
      <div class="qx-project-card">
        <div class="qx-project-title">Asynchronous Real-Time Tracker UI</div>
    ...
    <div class="qx-project-col">
      <div class="qx-project-card">
        <div class="qx-project-title">Foundation Array Math Engine</div>
